...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function applyTheme(withAnimation = true) {
    ...
    tl.add(() => {
      ...
      const isDarkNext = !document.body.classList.contains("dark-mode");

      if (document.startViewTransition) {
        document.startViewTransition(() => {
          document.body.classList.toggle("dark-mode", isDarkNext);
        }, { reverse: !isDarkNext }); // <-- beri tahu animasi mundur saat dark → light
      } else {
        document.body.classList.toggle("dark-mode", isDarkNext);
      }
    });
